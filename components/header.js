...
import openseaLogo from '../assets/AUROOMLOGO.png'
      ...
      <div className={style.wrapper}>
        <Link href="/">
          <div className={style.logoContainer}>
            <Image src={openseaLogo} height={40} width={120} />
          </div>
        </Link>
        ...
        <div className={style.headerItems}>
          <Link href="/collections/0x0dd42B84748CBB0176eb00CCD8D04AD02744CdE2">
